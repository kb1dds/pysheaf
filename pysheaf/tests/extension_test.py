# Try to extend Assignments, based on examples found in Chapter 3 of
...
# Extending to a connecting edge (using the previously extended Assignments)
if not sec5.extend(sh3,3) and sec6.extend(sh3,3):
    print "Test 4 passed"
else:
    print "Test 4 failed"

# Extending a very underdetermined Assignment
...
# ... and in which a Assignment does not completely extend
